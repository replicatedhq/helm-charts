...
{{- end }}
  ...
  {{- with (mergeOverwrite (deepCopy $.Values.defaults.probes.livenessProbe) $containerValues.livenessProbe) }}
  livenessProbe:
    {{- toYaml . | nindent 4 }}
  {{- end }}
  ...
  {{- with (mergeOverwrite (deepCopy $.Values.defaults.probes.readinessProbe) $containerValues.readinessProbe) }}
  readinessProbe:
    {{- toYaml . | nindent 4 }}
  {{- end }}
  {{- else if and (hasKey $containerValues "ports") $containerValues.ports }}
  ...
  {{- with (mergeOverwrite (deepCopy $.Values.defaults.probes.startupProbe) $containerValues.startupProbe) }}
  startupProbe:
    {{- toYaml . | nindent 4 }}
  {{- end }}
  {{- end }}
